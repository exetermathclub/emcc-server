...
method:"GET",data:{username:a},success:function(){$("#prompt").text("We have sent the password reset information to the email you registered with, please check your email.");e.removeClass("loading");f.removeAttr("disabled");f.text("Resend")}})}var c=$("#login_tip"),g=$("#username"),h=$("#password"),k=$("#button"),l=$("#dialog"),m=$("#cover"),d=$("#dialog_input"),f=$("#dialog_submit"),e=$("body");k.click(function(){a(g.val(),h.val())});h.keyup(function(a){a&&13===a.keyCode&&k.click()});$("#forgot").click(function(){l.show();
m.show();d.focus()});m.click(function(){$(this).hide();l.hide()});f.click(function(){""!==d.val()?($(this).attr("disabled",""),e.addClass("loading"),b(d.val())):d.css("background-color","yellow")});d.keyup(function(a){a&&13===a.keyCode&&f.click()})});
