...
//	mysql_free_result($result11);
	...
	// get the information to determine whether this user has participated in 2012
	
	//fetch account information
	$query12 =  "SELECT COUNT(*) AS COUNT FROM `emc2_tscores_2012` AS t1 " .
		"INNER JOIN emc2_teams_2012 AS t2 " .
		"ON t1.team_id = t2.team_id " .
		 "WHERE email = '{$_SESSION['email']}';";
	...
	//fetch account information
	$query13 =  "SELECT COUNT(*) AS COUNT FROM `emc2_tscores` AS t1 " .
    ...
    $num_rows12 = mysql_num_rows($result13);
...
?>
<p>
  Thanks for participating in the 2013 Exeter Math Club Competition! Detailed
  score reports for your students from the 2013 competition are available <a href="team-scores-2013.php">here. </a>
</p>
...
<input type="hidden" name="oldname" value="<?php echo $team['name']; ?>"  >
  ...
  <tr>
    <th>
    	...
    	<input type="text" disabled="disabled" name="name" value="<?php echo htmlspecialchars($team['name']); ?>" >
        <?php
...
?>
    ...
    <td>
    	...
    	<input type="text" disabled="disabled" name="p1" value="<?php echo htmlspecialchars($team['p1']); ?>" >
        <?php
...
?>
    ...
    <td>
    	...
    	<input type="text" disabled="disabled" name="p2" value="<?php echo htmlspecialchars($team['p2']); ?>" >
<?php
...
?>
    ...
    <td>
    	...
    	<input type="text" disabled="disabled" name="p3" value="<?php echo htmlspecialchars($team['p3']); ?>" >
        <?php
...
?>
    ...
    <td>
    	...
    	<input type="text" disabled="disabled" name="p4" value="<?php echo htmlspecialchars($team['p4']); ?>" >
<?php
