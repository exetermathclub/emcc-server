...
<p><font color="red">Registration for the 2013 competition is now closed! 
    You can still log in to view your registration, but you cannot change it. 
    If you need to update team rosters or add new teams/individuals please email us. </font> </p>

<p>  We will have an unofficial online tournament this year which will run at the same time 
as our regular tournament. </font> Registration for the online tournament is available now at <a href="test/registration.php">here</a>. </p>
<p>If you
registered for previous competitions, you may access your
information through the login.
<!--<font color="red">You have to re-enter your students and team information to register for this year's competition. 
You can modify your team rosters on our website before the registration closes.</font>
If you want to bring more teams, please contact us.</p>-->
...
<ul>
  <li>
	...
	Registration is $50 for a team of four students, $15 for an individual.
	<br>
...
<table>
  <tr>
	...
	<input type="text" disabled="disabled" name="fullname" value="<?php echo htmlspecialchars($_POST["fullname"]); ?>"   > 
<?php
...
?>
	...
	<input type="text" disabled="disabled" name="email" value="<?php echo htmlspecialchars($_POST["email"]); ?>"  > 
<?php
		if ($reg_error["email"])
		{
?>
...
?>
	...
	<input type="password" disabled="disabled" name="password"  >
<?php
...
?>
	...
	<input type="password" disabled="disabled" name="password2" >
    </td>
  </tr> <tr>
    <th colspan=2>
	...
	<input type="text" disabled="disabled" name="schoolname" value="<?php echo htmlspecialchars($_POST["schoolname"]); ?>"  > 
<?php
