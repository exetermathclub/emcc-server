<?php
	...
	$in_query = "SELECT t1.team_id, t1.indiv_id, t4.studentName AS Name, ".
			...
			" (emc2_temp_iscores_rank as t5) ON (t5.team_id = t1.team_id AND t5.indiv_id = t1.indiv_id)  inner join " . 
			"  (emc2_temp_iscores_rank_A as t6) ON (t6.team_id = t1.team_id AND t6.indiv_id = t1.indiv_id)  inner join  " .
	"  (emc2_temp_iscores_rank_B as t7) ON (t7.team_id = t1.team_id AND t7.indiv_id = t1.indiv_id)    " .
	        " WHERE t1.team_id IN ($wherestring) " .
