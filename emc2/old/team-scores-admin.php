...
session_start();
	...
	$query = "SELECT team_id FROM emc2_teams;";
	...
	//Team Scores
	$tm_query = "SELECT t1.team_id, t2.name, t1.total, r1.rank as RANK, t1.Tsum, r2.rankTSum as RANKTScore, t1.Gsum as guts, r3.RANKGSum as RANKGuts, t1.indivsum, r4.rankIndivSum as RANKInd, " .
		 " t1.T1, t1.T2, t1.T3, " . 
		 ...
		 " FROM emc2_tscores AS t1 " .
		 "INNER JOIN (emc2_teams AS t2, emc2_accounts AS t3) ON " .
		 "(t1.team_id = t2.team_id AND t2.email = t3.email) " .
	" INNER JOIN emc2_tscores_ranktotal as r1 ON t1.team_id = r1.team_id ".
	" INNER JOIN emc2_tscores_rankTSum as r2 ON t1.team_id = r2.team_id ".
	" INNER JOIN emc2_tscores_rankGSum as r3 ON t1.team_id = r3.team_id ".
	" INNER JOIN emc2_tscores_rankIndivSum as r4 ON t1.team_id = r4.team_id ".		 
		 "ORDER BY t1.team_id;";
	...
	$in_query = "SELECT t1.team_id, t1.indiv_id, t4.studentName AS Name, ".
		    "t2.name As 'Team Name', t1.total, t5.rank as RANK, t1.ASum as SSum, t6.RankA as SpeedRANK, t1.BSum as ASum, t7.RankB as AccuracyRANK, t1.A1 as S1, t1.A2 as S2, t1.A3 as S3, t1.A4 as S4, " .
		    ...
		    "t1.total FROM emc2_iscores AS t1 INNER JOIN " .
		    "(emc2_teams AS t2, emc2_accounts AS t3, emc2_students " .
		    "AS t4) ON (t1.team_id = t2.team_id AND t2.email = " .
		    "t3.email AND t1.team_id = t4.team_id AND t1.indiv_id " .
		    "= t4.indiv_id) inner join " .
			" (emc2_iscores_rank as t5) ON (t5.team_id = t1.team_id AND t5.indiv_id = t1.indiv_id)  inner join " . 
			"  (emc2_iscores_Arank as t6) ON (t6.team_id = t1.team_id AND t6.indiv_id = t1.indiv_id)  inner join  " .
	"  (emc2_iscores_Brank as t7) ON (t7.team_id = t1.team_id AND t7.indiv_id = t1.indiv_id)    " .
