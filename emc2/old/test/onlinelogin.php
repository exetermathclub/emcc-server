...
?>
  ...
  <p>The online tournament for this year on <?php echo $online_date;?> has completed. 
            Participating teams can log in <a href="registration.php">here</a> to check score report. </p>                               
...
<p>Thanks for participating in our unofficial online competition.
Results will be available on January 27, 2013. Solutions will be available on home page next week.</p>
<p>Please send us feedback by email to 
<a href="mailto:exetermathclub+EMC2@gmail.com">exetermathclub+EMC2@gmail.com</a>. Thanks!</p>
...
<form action="onlinelogin.php" method="post">
	...
	<input disabled ="disabled" type="submit" name="submitted" value="Log In">
</form>
