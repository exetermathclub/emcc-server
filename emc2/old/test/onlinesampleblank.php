<?php
    ...
    /***********************************************************************
     * onlinesampleblank.php
     *
     * Joy Zheng, Allen Yuan, In Young Cho
     *
     * 
     * Page created after CS50 project so that students can test out the submission form 
     *
     **********************************************************************/
...
*/
    ...
    $pg_name = "Online Sample Submission Form";	    
...
<script type="text/javascript">
    ...
    function ajax1(probNum, actionCode, changeCode, selected)
    {
        ...
        var ajaxUrl = "online_answerfunctions.php?sample=y&";
        ...
        if(actionCode == 1)
        {
            //turn cursorPlaceId from "iBj" to "i"
            var i = 0;
...
<h1>Online Tournament Sample Submission Form</h1>

        <p>Below is an answer blank just like the ones that you will use to submit your answers
            during the actual contest.  <p></p>Please take your time to familiarize yourself with using
            the answer blank. </p>
        

<h2>Sample Answer Submission</h2>
        

<p>Instructions: Use the buttons on the right to toggle the format of each answer. Remember that you must click into a box before clicking any of the buttons in order to format.
...
<?php         
    ...
    for($k = 1; $k<= 1; $k++)
    {
        echo "<tr> <td id='prob" . $k . "'><h3>Sample Problem " . "</h3></td></tr>";
        ...
        //various buttons
        echo "<td><div align='center'><button type ='button' onclick =\"ajax1($k, 0, -1, -1) \" > Clear Sample Problem " . "</button>";
        echo "<button type ='button' onclick =\"ajax1($k, 2, -1, -1) \"> Submit Sample Problem " . "</button>";
