<?php
     ...
     * Final Project
     *
     * Competition page for online team round
     **********************************************************************/
...
<script type="text/javascript">
    ...
    function ajax1(probNum, actionCode, changeCode, selected)
    {
        ...
        if(actionCode == 1)
        {
            //turn cursorPlaceId from "iTj" to "i"
            var i = 0;
...
<h1>Online Tournament Team Round</h1>
...
<h2>Problems</h2>
    ...
    <a href="EMC2Team.pdf">Download a pdf of the problems here.</a>
