<?php
     ...
     * Final Project
     *
     * (nonexistent) pictures from 2010 competition
     **********************************************************************/
	...
	if ($_GET["c"] !== NULL)
	{
		...
		$captionpath = '/var/www/emc2/pictures/captions/' . $image . '.txt';
...
<table>
  <tr>
    ...
    <td colspan=3 style='img_800x800'>
    	<a href='photos.php?{$to_next}'>
    	  <img src='pictures/$image' alt='$image'>
	</a>
    </td>
  </tr> <tr>
...
<?php
    ...
    <td class="img_thumbnail">
    	<a href='photos.php?c=guts&n=$i'>
    	  <img src='pictures/thumbs/Guts_$j.png' alt='Guts_$j.JPG'>
	</a>
    </td>
HTML;
		}
...
<?php
    ...
    <td class="img_thumbnail">
    	<a href='photos.php?c=cool&n=$i'>
    	  <img src='pictures/thumbs/Cooldown_$j.png' alt='Cooldown_$j.JPG'>
	</a>
    </td>
HTML;
		}
...
<?php
    ...
    <td class="img_thumbnail">
    	<a href='photos.php?c=awrd&n=$i'>
    	  <img src='pictures/thumbs/Awards_$j.png' alt='Awards_$j.JPG'>
	</a>
    </td>
HTML;
		}
