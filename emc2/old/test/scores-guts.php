...
<p>Scores for each round are 3, 5, 6, 7, 9, 11, 12, 14, 16, 17</p>
    ...
    <td>
	  ...
	  <tr>
	    <th>
	    	...
	    	<input type="radio" name="setnum" value="7"> 7
	    </td> <td>
	    	<input type="radio" name="setnum" value="8"> 8
	    </td> <td>
	    	<input type="radio" name="setnum" value="9"> 9
	    </td> <td>
	    	<input type="radio" name="setnum" value="10"> 10	
